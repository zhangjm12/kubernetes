...
export MASTER=${MASTER:-"vagrant@192.168.33.10"}
...
# And separated with blank space like <user_1@ip_1> <user_2@ip_2> <user_3@ip_3>.
# The user should have sudo privilege
export NODES="${NODES:-"vagrant@192.168.33.11 vagrant@192.168.33.12 vagrant@192.168.33.13"}"
...
export DOCKER_OPTS=${DOCKER_OPTS:-"--insecure-registry 10.0.0.0/8 --insecure-registry 192.168.0.0/16"}
